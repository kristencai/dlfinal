...
def preprocess_images():
    ...
    # Here we start image preprocessing and augmentation.
...
# NOTE: This is failed preprocessing technique.
# def preprocess_images():
#     labels = []
#     id_to_label = {}
#     line_count = 0
...
#         classes=1000)
#     directory = 'images'
#     # Try using a conv2d layer with multiple output channels to extract the 
...
# NOTE: Unpickle for failed preprocessing.
# # def unpickle_vgg():
#     data = {
#     }
